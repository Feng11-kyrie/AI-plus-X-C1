...
| 失效 | 5 |
| 原始体积 | 20.82 MB |
| 清洗后 Markdown | 0.53 MB |
| **有效条目压缩率** | **2.6%**（降至 1/38.7） |
| 可翻译正文词数 | 81,687 |
| 翻译分块数 | 271（合并小块前为 398 块——合并见「合并过小相邻块」的设计说明） |
| 平均块大小 | 2,051 字符（合并前中位数仅 795） |
...
| W1 | `prompt-engineering-overview` | html | 1958 KB | 16.5 KB | **0.8%** | **100.0%** | — | 2,486 | 13 | OK | — |
...
| 翻译分块 | `pipeline/work/chunks.json`（271 块） | ⬜ 中间产物，可复跑再生 |
