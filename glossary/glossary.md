...
**术语总数：170 条**（其中禁用变体 370 条，由 `pipeline/qc_terminology.py` 全文扫描强制校验）

## 核心 LLM 与提示词（28 条）

| 英文 | 中文 | policy | 禁用变体 | 语料频次 |
|---|---|---|---|---|
...
| Agent | 智能体 | `translate` | 代理、智能代理、代理人、Agent 体 | 45 |
...
| Workflow | 工作流 | `translate` | 流程、工作流程、作业流 | — |
...
| False Positive Rate (FPR) | 假阳性率（FPR） | `acronym` | 误报率 FPR、假报率 | — |
