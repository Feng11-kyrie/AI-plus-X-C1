...
<!-- week: 4 | format: pdf | original: How Anthropic Uses Claude Code -->
...
Claude Code for data science and visualization 1 1
11
Claude Code for API
Claude Code for API 13
13
Claude Code for growth marketing Claude Code for growth marketing
15
15
Claude Code for product design Claude Code for product design
17
17
Claude Code for RL engineering Claude Code for RL engineering
19
19
...
2
2 H o w HOW ANTHROPIC TEAMS USE CLAUDE CODEA n t h r o p i c t e a m s u s e C l a u d e C o d e
...
context loss.
3
3 C l a u d e CLAUDE CODE FOR DATA INFRASTRUCTUREC o d e fo r data i n f r a s t r u c t u r e
...
their own.
4
4 C l a u d e CLAUDE CODE FOR DATA INFRASTRUCTUREC o d e fo r data i n f r a s t r u c t u r e
...
context switching.
5 C l a u d e 5
CLAUDE CODE FOR PRODUCT DEVELOPMENTC o d e fo r p r o d u c t d e v e l o p m e n t
...
6
6 C l a u d e CLAUDE CODE FOR PRODUCT DEVELOPMENTC o d e fo r p r o d u c t d e v e l o p m e n t
...
create markdown runbooks, troubleshooting guides, and over views.
...
instead of weeks.
7
7 C l a u d e CLAUDE CODE FOR SECURITY ENGINEERINGC o d e fo r s e c u r i t y e n g i n e e r i n g
...
8 C l a u d e 8
CLAUDE CODE FOR SECURITY ENGINEERINGC o d e fo r s e c u r i t y e n g i n e e r i n g
...
9
9 C l a u d e CLAUDE CODE FOR INFERENCEC o d e fo r i n f e r e n c e
...
1 1 11
C l a u d e CLAUDE CODE FOR DATA SCIENCE AND VISUALIZATIONC o d e fo r data s c i e n c e a n d v i s u a l i z at i o n
...
mental overhead.
13
1 3 CLAUDE CODE FOR APIC l a u d e C o d e fo r A P I
...
1 5 15
C l a u d e CLAUDE CODE FOR GROWTH MARKETINGC o d e fo r g r o w t h m a r k e t i n g
...
forth coordination.
1 7 17
C l a u d e CLAUDE CODE FOR PRODUCT DESIGNC o d e fo r p r o d u c t d e s i g n
...
19
1 9 C l a u d e CLAUDE CODE FOR RL ENGINEERINGC o d e fo r R L e n g i n e e r i n g
...
2 0 20
C l a u d e CLAUDE CODE FOR RL ENGINEERINGC o d e fo r R L e n g i n e e r i n g
...
investing more time.
21
2 1 CLAUDE CODE FOR LEGALC l a u d e C o d e fo r l e g a l

<!-- page 22 -->
Claude Code for legal
Work style and impact Work style and impact
