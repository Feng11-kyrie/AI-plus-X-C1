...
This was always a mistake. In my [Product Competency Toolkit](https://www.ravi-mehta.com/product-manager-skills/), Feature Specification sits at the top—first among twelve competencies—for a reason. It underpins Product Execution, along with Product Delivery and Product Quality.
...
In his recent talk [Building Faster with AI](https://www.youtube.com/watch?v=RNJCfif1dPY), Andrew Ng noted an unprecedented trend:
...
This validates what we predicted in [our previous post](https://blog.ravi-mehta.com/p/will-ai-kill-product-management): as engineers deliver many times faster with AI, companies **need more PMs to support those productive engineers, not fewer**.
...
Sean Grove, from OpenAI, has a provocative thesis. In his recent talk, [The New Code](https://www.youtube.com/watch?v=8rABwKRsec4), he argues that a well-written prompt (i.e., the spec) is the new source code.
...
Let's look at a hands-on example of how this all plays out. [Danny Martinez](https://open.substack.com/users/4227372-danny-martinez?utm_source=mentions) is the founder of decimals, a platform (in stealth) that enables experts in the creator economy to place talent from their network into jobs.

- **Are you an AI-first PM looking for a new opportunity?** [Drop in your details](https://www.decimals.co/profile/8580aaec-6b19-4174-a835-630a29ffe7ac/apply) and we’ll let you know when we come across interesting opportunities.
- **Are you a company looking to hire an AI-first PM?** [Apply to our talent network](https://www.decimals.co/profile/8580aaec-6b19-4174-a835-630a29ffe7ac/company-apply) and we’ll share a curated shortlist of candidates.
...
- **Project management tool**: [Linear](https://linear.app/homepage)
...
- **MCP Server**: [Linear MCP server](https://linear.app/changelog/2025-05-01-mcp) to allow Linear tickets to be accessed via Copilot
