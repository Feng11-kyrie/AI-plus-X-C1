...
- Using 1 run of **Anthropic Claude Code** (v1.0.32, Sonnet 4) and **OpenAI Codex** (v0.2.0, o4-mini) out of the box with a simple, scripted prompt [1] reused for the different kinds of vulnerabilities. We asked them to return [SARIF formatted](https://sarifweb.azurewebsites.net/) security issues.
