...
<!-- week: 7 | format: pdf | original: AI-Assisted Assessment of Coding Practices in Modern Code Review -->
...
<!-- page 2 -->
AIware ’24, July 15–16, 2024, Porto de Galinhas, Brazil addition to reviewing (and learning about) the code contributions
...
sponds to the start of the Add function) and a go.dev URL, pointing
...
<!-- page 4 -->
AIware ’24, July 15–16, 2024, Porto de Galinhas, Brazil 3.2.2 Dataset curation. Dataset curation is a single, on-demand
...
in section 3.1, into the standard TensorFlow Example data structure.
...
define 𝑃𝑟𝑒𝑐𝑖𝑠𝑖𝑜𝑛𝑡 as the number of correct predictions whose confi-
dence score is greater than 𝑡 divided by the number of all predictions
whose confidence score is greater than 𝑡; we define 𝑅𝑒𝑐𝑎𝑙𝑙𝑡 analo-
gously. These definitions allow us to estimate how many (in)correct
results would be shown to a user, as a function of 𝑡. 𝑃𝑟𝑒𝑐𝑖𝑠𝑖𝑜𝑛𝑡 and
𝑅𝑒𝑐𝑎𝑙𝑙𝑡 are used for model checkpoint comparisons during training.
...
<!-- page 6 -->
AIware ’24, July 15–16, 2024, Porto de Galinhas, Brazil 4.2 Suppressing Outdated Best Practices
...
<!-- page 7 -->
AI-Assisted Assessment of Coding Practices in Modern Code Review Figure 5: Cumulative distribution of comments per URL for
...
<!-- page 8 -->
AIware ’24, July 15–16, 2024, Porto de Galinhas, Brazil URL, we inspected its best practice document and determined (1) the
...
<!-- page 9 -->
AI-Assisted Assessment of Coding Practices in Modern Code Review REFERENCES
