...
<!-- week: 9 | original: Google SRE - IT Service Management: Automate Operations -->

## Introduction

Written by Benjamin Treynor Sloss6
...
Conflict isnât an inevitable part of offering a software service. Google has chosen to run our systems with a different approach: our [Site Reliability Engineering teams](https://sre.google/sre-book/software-engineering-in-sre/) focus on hiring software engineers to run our products and to [create systems to accomplish the work](https://sre.google/sre-book/distributed-periodic-scheduling/) that would otherwise be performed, often manually, by sysadmins.
...
Reliability is a function of mean time to failure (MTTF) and mean time to repair (MTTR) [[Sch15]](/sre-book/bibliography#Sch15). The most relevant metric in evaluating the effectiveness of emergency response is how quickly the response team can bring the system back to healthâthat is, the MTTR.
