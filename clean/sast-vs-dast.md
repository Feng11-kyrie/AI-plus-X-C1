...
2. Tests the application from the outside to identify vulnerabilities that only emerge during runtime.
...
and frameworks; requires compatibility with the tool.
