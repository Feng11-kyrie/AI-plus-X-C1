...
| 口径 | 数量 | 说明 |
|---|---|---|
| 分母（本地 readings） | 34 | pages 31 + pdf 3 |
| 可用条目 | 32 | 内容完整，可进入翻译管线 |
| 损坏条目 | 2 | 需补抓或声明缺口 |
| 达到 80% 所需最少条目 | 27 | ceil(34 × 0.8) |
| 可用英文正文字数（估） | ≈ 70,719 | 仅 HTML 可用条目，PDF 未计 |
...
| # | 周 | 标题 | 文件 | 字节 | 症状 | 处置建议 |
|---|---|---|---|---|---|---|
| 1 | W4 | Peeking Under the Hood of Claude Code | `source/pages/peeking-under-the-hood-of-claude-code.html` | 550 | 占位页，源站反爬拦截 | 源站为 Medium，自动化访问被拦；需人工导出或声明缺口 |
| 2 | W7 | Lessons from Millions of AI Code Reviews | `source/pages/lessons-from-ai-code-reviews.html` | 0 | 0 字节，抓取完全失败 | 重新抓取源站（见 page_map 中的原始 URL） |
...
图例：`OK` 可用 ｜ `EMPTY` 0 字节 ｜ `PLACEHOLDER` 占位页 ｜ `EXTERNAL` 外链
...
| OK | local/html | Prompt Engineering Guide | `source/pages/prompt-engineering-guide.html` | 374 |
| OK | local/html | Prompt Engineering Overview | `source/pages/prompt-engineering-overview.html` | 3,521 |
...
| OK | local/html | MCP Food-for-Thought | `source/pages/mcp-food-for-thought.html` | 905 |
| OK | local/html | MCP Introduction | `source/pages/mcp-introduction.html` | 4,816 |
| OK | local/html | MCP Registry | `source/pages/mcp-registry-preview.html` | 818 |
| OK | local/html | MCP Server Authentication | `source/pages/mcp-server-authentication.html` | 2,015 |
...
| OK | local/html | Devin: Coding Agents 101 | `source/pages/devin-coding-agents-101.html` | 3,411 |
| OK | local/html | How Long Contexts Fail | `source/pages/how-long-contexts-fail.html` | 1,649 |
| OK | local/html | Specs Are the New Source Code | `source/pages/specs-are-the-new-source-code.html` | 2,163 |
| OK | local/html | Writing Effective Tools for Agents | `source/pages/writing-effective-tools-for-agents.html` | 3,347 |
...
| OK | local/html | Claude Best Practices | `source/pages/claude-code-best-practices.html` | 1,566 |
| OK | local/html | Good Context Good Code | `source/pages/good-context-good-code.html` | 15 |
| **PLACEHOLDER** | local/html | Peeking Under the Hood of Claude Code | `source/pages/peeking-under-the-hood-of-claude-code.html` | 43 |
...
| OK | local/html | How Warp Uses Warp to Build Warp | `source/pages/how-warp-uses-warp.html` | 15 |
| OK | local/html | Warp vs Claude Code | `source/pages/warp-vs-claude-code.html` | 768 |
...
| OK | local/html | Agentic AI Threats: Identity Spoofing and Im | `source/pages/agentic-ai-threats.html` | 7,569 |
| OK | local/html | Context Rot: Understanding Degradation in AI | `source/pages/context-rot.html` | 7,566 |
| OK | local/html | Copilot Remote Code Execution via Prompt Inj | `source/pages/copilot-prompt-injection-rce.html` | 1,225 |
| OK | local/html | Finding Vulnerabilities in Modern Web Apps U | `source/pages/finding-vulnerabilities-claude-codex.html` | 4,042 |
| OK | local/html | OWASP Top Ten: The Leading Web Application S | `source/pages/owasp-top-ten.html` | 2,535 |
| OK | local/html | SAST vs DAST | `source/pages/sast-vs-dast.html` | 3,024 |
...
| 状态 | 类型 | 标题 | 本地路径 / 来源 | 字数 |
|---|---|---|---|---|
| OK | local/html | AI Code Review Implementation Best Practices | `source/pages/ai-code-review-best-practices.html` | 2,015 |
| OK | local/html | Code Review Essentials for Software Teams | `source/pages/code-review-essentials.html` | 2,053 |
| OK | local/html | Code Reviews: Just Do It | `source/pages/code-reviews-just-do-it.html` | 949 |
| OK | local/html | How to Review Code Effectively | `source/pages/how-to-review-code-effectively.html` | 3,865 |
...
| 状态 | 类型 | 标题 | 本地路径 / 来源 | 字数 |
|---|---|---|---|---|
| OK | local/html | Your New Autonomous Teammate / Benefits of A | `source/pages/benefits-agentic-ai-oncall.html` | 1,001 |
| OK | local/html | Kubernetes Troubleshooting with AI | `source/pages/kubernetes-troubleshooting-ai.html` | 1,421 |
| OK | local/html | Role of Multi Agent Systems in Making Softwa | `source/pages/multi-agent-systems-ai-native.html` | 2,026 |
| OK | local/html | Observability Basics You Should Know | `source/pages/observability-basics.html` | 1,848 |
| OK | local/html | Introduction to Site Reliability Engineering | `source/pages/sre-introduction.html` | 4,197 |
